...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= ROOT_URL ?>assets/css/jquery.timepicker.min.css">
...
<?php }else{ ?>
    ...
    <?php } ?>
        ...
        <a href="<?php echo ROOT_URL; ?>"><h3 class="text-muted"><?php echo SITE_TITLE; ?></h3></a>
      </header>
   ...
   <!-- Optional JavaScript -->
    ...
    <script src="<?= ROOT_URL ?>assets/js/jquery.timepicker.min.js"></script>
